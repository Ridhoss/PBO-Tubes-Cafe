...
public class DummyOrdersDao {
    ...
    private void generateDummyData() {
        ...
        // Product(...)
        Product kopi = new Product(1, 1, "Kopi Susu Gula Aren", "Kopi enak", 18000, 10000, 100, true, null, null, null);
        Product snack = new Product(2, 2, "Kentang Goreng", "Gurih", 15000, 8000, 100, true, null, null, null);
        Product meal = new Product(3, 3, "Nasi Goreng", "Spesial", 25000, 15000, 100, true, null, null, null);
        ...
        // Kasus: Customer pesan via app, bayar debit, status PENDING (Menunggu Approval
        // Kasir)
